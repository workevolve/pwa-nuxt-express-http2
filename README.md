# nuxtjs with express and http/2

- Progressive Web App with Vuejs running on express with HTTP/2
...
- [For this template](https://github.com/workevolve/pwa-nuxt-express-http2): common questions specific to this template are answered and each part is described in greater detail
